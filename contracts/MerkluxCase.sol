...
import {Block, Action} from "./Types.sol";
...
contract MerkluxCase is Secondary, MerkluxVM {
    ...
    //        originalBlock.actions = _actions;
    ...
    //    {
    //        // check nonce & signature & action hash
    //        require(actionNum == _height);
    //
    //        // check the signature
    ...
    //            )).toEthSignedMessageHash().recover(_actionSig);
    //
    //        // check user's action nonce for this block is valid
    //        require(getAccountActionNonce(sender) < _nonce);
    //
    //        // increase nonce
    //        _increaseAccountsActionNonce(sender, _nonce);
    //
